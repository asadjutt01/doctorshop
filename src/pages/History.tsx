...
import HistoryBanner from "../app/images/History-banner.webp";
...
export default function History() {
  const cardsData = [
    {
      ...
      title: "Quality:",
      description:
        "We are committed to lore sourcing and delivering only the highest quality medical supplies, ensuring the safety and well-being of patients.",
    },
    {
      icon: Relability,
      title: "Reliability:",
  ...
  return (
    <div className="history-main">
      ...
      <div
        className="lg-container lg-container-padding {
      ...
      >
        ...
        <div className="cards-disc">
          <p>
            Contact us today to start a meaningful partnership with My Doctor
            Shop, where connecting care is at the heart of everything we do.
          </p>
        </div>
      </div>
